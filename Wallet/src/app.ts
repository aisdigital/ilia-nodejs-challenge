...
import MessengerListenerService from './services/messengerListenerService.service';
...
class App {
  ...
  constructor(routes: Routes[]) {
    ...
    this.connectToDatabase()
      .then(async () => {
        ...
        this.initializeMessengerListeners();
      })
      .catch(logger.crit);
  }
  ...
  initializeMessengerListeners() {
    new MessengerListenerService('users', new UserService()).consume();
  }
