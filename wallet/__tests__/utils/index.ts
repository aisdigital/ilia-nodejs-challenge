...
import { Transaction } from '../../src/modules/transaction/models/Transaction';
...
export const createFakeTransaction = async (user_id: string, type?: 'DEBIT' | 'CREDIT') => {
  return await mongoose.model<Transaction>('Transaction').create({
